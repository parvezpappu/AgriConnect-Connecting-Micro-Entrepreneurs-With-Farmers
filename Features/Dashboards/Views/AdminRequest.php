    ...
    ?>
        <tr>
          ...
          <td>
            ...
            <form action="../Controllers/ApporveRequestAdmin.php" method="post" style="display:inline;">
                <input type="hidden" name="email" value="<?php echo $row['Email']; ?>"> 
                <input type="submit" name="approve" value="Approve">
                </form>

                <form action="../Controllers/RejectRequestAdmin.php" method="post" style="display:inline;">
                <input type="hidden" name="email" value="<?php echo $row['Email']; ?>">
